...
def run_simulation(num_agents_sim, out_filename):
    ...
    env_params = env.default_params.replace(num_agents=num_agents_sim, map_size=2000.0, num_obstacles=45, ocean_current=jnp.array([0.5, 0.2, 0.0]))
...
if __name__ == "__main__":
    ...
    run_simulation(6, "visualizations_contributions/contrib2_N6.mp4")
