...
def main():
    ...
    console.print("[yellow]Rendering MP4/GIF Animation... (This may take a minute)[/yellow]")
    anim.save('logs/swarm_simulation_lstm.gif', writer='pillow', fps=30)
    console.print("[bold green]✔ Saved gorgeous swarm simulation to logs/swarm_simulation_lstm.gif[/bold green]")
    plt.close()
